...
python replace_submit.py --input replace_mvis.sh --etamin 0 --etamax 3 --ptmin 10 --ptmax 20 --iso MVAoldM --dm all --decaymodefinding old --nvtxmin 0 --nvtxmax 1000 --switch_bins 2 --switch_var 4 --plotName muMt
...
python replace_submit.py --input replace_mvis.sh --etamin 0 --etamax 3 --ptmin 10 --ptmax 20 --iso MVAoldM --dm all --decaymodefinding old --nvtxmin 0 --nvtxmax 1000 --switch_bins 9 --switch_var 6 --plotName tauMass
